...
// import maleVideo from "../assets/videos/male-ai (1).mp4"
// import femaleVideo from "../assets/videos/female-ai (1).mp4"
...
// // Falback: first voice (assume female) 
...
//       <div className='w-full max-w-[1000px] min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
...
//              {isAIPlaying && <span className='text-xs sm:text-sm font-semibold text-emerald-600 whitespace-nowrap'>
...
//       interview},{withCredentials:true}
...
// value={answer}
// onChange={(e)=>setAnswer(e.target.value)}
// className='flex-1 bg-gray-100 p-6 rounded-2xl resize-none outline-none border border-gray-200'
// />
...
// <div className='mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl'>

// <p className='text-emerald-700 mb-4'>{feedback}</p>

// <button
// onClick={handleNext}
// className='w-full bg-emerald-600 text-white py-3 rounded-xl flex items-center justify-center gap-1'>
