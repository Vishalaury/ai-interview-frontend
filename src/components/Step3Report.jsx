...
function Step3Report({ report }) {
    ...
    // ✅ FINAL FIX (handles all cases safely)
    const questionScoreData = questionWiseScore.map((item, index) => ({
        name: `Q${index + 1}`,
        score: Number(item.score ?? item.correctness ?? 0)
    }));
...
let advice = "";
if(finalScore >= 8){
    advice = "Excellent performance. Maintain confidence and structured. Continue refining clarity and support answers with strong real-world examples.";
}else if (finalScore >= 5){
    advice = "Good foundation show. Improve clarity and structure. Practice delivering concise, confident answers with stronger supporting example."
}else{
    advice = "Significant improvement required. Focus on structuring thinking clarity, and confident delivery. Practice answering aloud regularly.";
}
            ...
            <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                ...
                <div className='mb-10 w-full flex items-start gap-4 flex-wrap'>
                    ...
                    <button
                        ...
                        className='mt-1 p-3 rounded-full bg-white shadow transition'
                    >
                ...
                <button onClick={downloadPDF}
                 className='bg-emerald-600 text-white px-6 py-3 rounded-xl shadow-md transition-all duration-300 font-semibold text-sm sm:text-base cursor-pointer text-nowrap'>
                    Download PDF
                </button>
