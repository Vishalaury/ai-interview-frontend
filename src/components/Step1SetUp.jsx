...
//                        whileHover={{scale: 1.03}}
//                        whileTap={{scale:0.95}}
//                        className="w-full disabled:bg-gray-600 bg-green-600 hover:bg-green- text-white cursor-pointer py-3 rounded-full text-lg font-semibold transition duration-300 shadow-md" 
//                        >
//                         Start Interview
//                        </motion.button>
//            </div>
...
// const remainingSkills = skills.length - 6;
...
// animate={{opacity:1}}
// transition={{duration:0.6}}
// className="min-h-screen flex justify-center items-start bg-gradient-to-br from-gray-100 to-gray-200 py-16 px-4"
// >
...
// { role, experience, mode, projects, skills },
// { withCredentials: true }
// )
//     console.log(result.data)
//     if(userData){
...
// animate={{opacity:1}}
// transition={{duration:0.6}}
// className="min-h-screen flex justify-center bg-gradient-to-br from-gray-100 to-gray-200 px-4 py-12"
// >
...
function Step1SetUp({ onStart }) {
  ...
  const handleUploadResume = async () => {
    ...
    try {
      ...
      setProjects(result.data.projects || []);
      setSkills(result.data.skills || []);
      setResumeText(result.data.resumeText || ""); // ✅ IMPORTANT FIX
  ...
  const handleStart = async () => {
    ...
    try {
      const result = await axios.post(
        ServerUrl + "/api/interview/generate-questions",
        { role, experience, mode, resumeText, projects, skills }, // ✅ FIXED
        { withCredentials: true }
      );
