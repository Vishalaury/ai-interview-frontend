                        ...
                        <div className='grid md:grid-cols-2 gap-8'>
                            {
                                [
                                    ...
                                    <motion.div key={index}
                                        ...
                                        className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all max-w-md mx-auto'
                                    >
                                        ...
                                        <div className='flex items-center gap-6'>
                                            ...
                                            <div className='w-32 flex justify-center'>
                                                <img
                                                    ...
                                                    /* IMAGE SIZE INCREASED FOR HEIGHT BALANCE */
                          ...
                          desc: "Unlock premium interview sessions"
                                    ...
                                    >
                                        ...
                                        <div className='flex items-center justify-between gap-6'>
                                         ...
                                         <p className='text-gray-500 text-sm leading-relexed'>{mode.desc}</p>
                                         </div>
